...
sleep 5
ssh "${ssh_opt[@]}" -p $client_port ubuntu@$client bash -c "echo; cd /home/ubuntu/client-scripts; ./runexp-base-fair.sh $rc $dest $iterations ${proj}_${stamp} 2>&1" 
...
sleep 5
ssh "${ssh_opt[@]}" -p $client_port ubuntu@$client bash -c "echo; cd /home/ubuntu/client-scripts; ./runexp-kernel-fair.sh $rc $dest $iterations ${proj}_${stamp} 2>&1"
